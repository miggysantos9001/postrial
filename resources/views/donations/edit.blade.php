...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Donation Page</h1>
        <h3 style="color:blue;">{{ $donation->client->name }}</h3>
        <h3 style="color:green;">{{ \Carbon\Carbon::parse($donation->date)->toFormattedDateString() }}</h3>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
    		<div class="col-md-12">
                <a href="{{ action('DonationController@index') }}" class="btn btn-success btn-sm" style="margin-bottom: 10px;"><i class="glyphicon glyphicon-home"></i> Back to Donations</a>
                <table class="table table-bordered" id="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::text('heads[]',$data->heads,['class'=>'form-control heads','style'=>'width:100%;','id'=>'heads']) }}
