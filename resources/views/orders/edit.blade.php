...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        {!! Form::model($order,['method'=>'PATCH','action'=>['SVIBookingController@update',$order->id]]) !!}
    	<div class="row">
    		<div class="col-md-12">
		            ...
		            <div class="box-body">
                        ...
                        <div id="wrap">
                            <div class="wrapp">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="product_name[]" class="form-control" id="" value="{{ $data->product->name }}" readonly="readonly" />
                                        <input type="hidden" name="product_id[]" class="form-control" id="" value="{{ $data->product_id }}" readonly="readonly" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="text" name="heads[]" class="form-control heads" id="heads" value="{{ $data->heads }}" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('cashbond',null,['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('','Grand Total:') !!}
                                    {!! Form::text('gt',number_format($order->cashbond + $order->details()->sum('total_price'),2),['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
