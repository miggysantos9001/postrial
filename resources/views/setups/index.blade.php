...
<div class="content-wrapper">
    ...
    <section class="content">
    	...
    	<div class="row">
    		<div class="col-md-4">
    			{!! Form::open(['method'=>'POST','action'=>'SetupController@store','novalidate' => 'novalidate', 
        'files' => 'true']) !!}
		        <div class="box">
		            <div class="box-header with-border">
		                <h3 class="box-title">Create Setup</h3>
		            </div>
		            <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
    		...
    		<div class="col-md-8">
    			<div class="box">
    			    <div class="box-header with-border">
    			        <h3 class="box-title">Setup List</h3>
    			    </div>
    			    <div class="box-body">
    			    			...
    			    			<div class="modal fade" id="edit{{ $data->id }}">
		    			          	<div class="modal-dialog">
		    			            	<div class="modal-content">
		    			              		...
		    			              		{!! Form::open(['method'=>'PATCH','action'=>['SetupController@update',$data->id],'novalidate' => 'novalidate', 
        'files' => 'true']) !!}
		            	                        ...
		            	                        <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::file('logo',null,['class'=>'form-control']) !!}
                                                            @if($data->logo != NULL)
                                                            <img src="<?php echo asset('public/logos') ?>/{{ $data->logo }}" width="150">
                                                            @endif
                                                        </div>
                                                    </div>  
                                                </div>
