...
<div class="content-wrapper">
    ...
    <section class="content">
    	...
    	{!! Form::open(['method'=>'POST','action'=>['BookingController@post_booking_details',$booking->id,$customer->id]]) !!}
        <div class="row">
    		<div class="col-md-12">
                <a href="{{ action('BookingController@show',$booking->id) }}" class="btn btn-success btn-sm" style="margin-bottom: 10px;"><i class="glyphicon glyphicon-home"></i> Back to View Bookings</a>
