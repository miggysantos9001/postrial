...
<div class="content-wrapper">
    ...
    <section class="content">
    	...
    	<div class="row">
    		<div class="col-md-4">
    			{!! Form::open(['method'=>'POST','action'=>'CustomergroupController@store']) !!}
		        <div class="box">
		            <div class="box-header with-border">
		                <h3 class="box-title">Create Customer Group</h3>
		            </div>
		            <div class="box-body">
		            	<div class="row">
		            		<div class="col-md-12">
    			    			...
    			    			<div class="modal fade" id="edit{{ $data->id }}">
		    			          	<div class="modal-dialog">
		    			            	<div class="modal-content">
		    			              		...
		    			              		{!! Form::open(['method'=>'PATCH','action'=>['CustomergroupController@update',$data->id]]) !!}
